...
#SBATCH --mail-user=slamsal@iu.edu # Your email

# ============================================================
# Legal Domain Faithfulness Experiment on Quartz
# Fixed version for Quartz environment
# ============================================================
...
# Load modules - use available versions
module load python
module load cuda
...
# HuggingFace token (set your own)
...
# Use conda instead of venv (more reliable on Quartz)
...
# ============================================================
# Setup LegalBench dataset (simplified)
# ============================================================
...
if not os.path.exists(LEGAL_FILE):
    print('Creating simplified LegalBench dataset...')
    # Create a simple dataset manually to avoid schema issues
...
# ============================================================
# Register LegalBench handler (create file)
# ============================================================
